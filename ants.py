...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while position:
            if position.bees:
                if self.lower_bound<= steps <= self.upper_bound and position.is_hive is False:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        #the is container attribute can be useful
        # BEGIN Problem 8a
        #check two conditions: 
            #doesn't already contain another ant = (ant_contained)
            #other ant isn't container
    ...
    def store_ant(self, ant):
        # BEGIN Problem 8a
        #can call the store_ant and store ant in ant_contained instance
        
        #our instance attribute (ant_contained) stores the ant that
        #was passed in 
    ...
    def action(self, gamestate):
        # BEGIN Problem 8a
        #perform the action of ant inside 
        #need to check whether there is an ant inside, self.ant_contained
        #make sure to call the action method of that ant
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        while curr:
            ...
            if curr.ant: 
                curr.ant.double()
                if curr.ant.is_container:
                    if curr.ant.ant_contained:
                        curr.ant.ant_contained.double()
            curr = curr.exit
        # END Problem 12
